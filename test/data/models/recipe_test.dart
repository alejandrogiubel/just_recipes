...
void main() {
  group('Recipe model test', () {
    //load fake data
    final mockData =
        File('test/data/models/mock_data/recipe.json').readAsStringSync();

    //parse json
    final data = json.decode(mockData) as Map<String, dynamic>;

    //create mock from json
    final recipeFromJson = Recipe.fromJson(data);

    //create mock from constructor
    const recipeFromConstructor = Recipe(
      id: 716429,
    );
    ...
    test('Test instance equality', () {
      expect(
        recipeFromJson,
        equals(recipeFromConstructor),
      );
    });

    test('Test from json', () {
      expect(recipeFromJson, isA<Recipe>());
      expect(
        recipeFromJson,
        equals(Recipe.fromJson(data)),
      );
    });

    test('Test to json', () {
      expect(recipeFromJson.toJson(), isA<Map<String, dynamic>>());
      expect(recipeFromJson.toJson(), equals(data));
    });

    //create mock from json
    final randomRecipeFromJson = RandomRecipes.fromJson(const <String, dynamic>{
      'recipes': [
        {
          'id': 716429,
          ...
          'extendedIngredients': [
            ...
            },
            {
              ...
              'measures': {
                ...
                'us': {'amount': 2.0, 'unitLong': 'cups', 'unitShort': 'cups'}
              },
            ...
            },
            {
              ...
              'measures': {
                ...
                'us': {'amount': 2.0, 'unitLong': 'Tbsps', 'unitShort': 'Tbsps'}
              },
            ...
            },
            {
              ...
              'measures': {
                ...
                'us': {'amount': 6.0, 'unitLong': 'ounces', 'unitShort': 'oz'}
              },
            ...
            },
            {
              ...
              'measures': {
                'metric': {'amount': 3.0, 'unitLong': '', 'unitShort': ''},
                'us': {'amount': 3.0, 'unitLong': '', 'unitShort': ''}
              },
            ...
            },
            {
              ...
              'measures': {
                ...
                'us': {'amount': 0.25, 'unitLong': 'cups', 'unitShort': 'cups'}
              },
    ...
    //create mock from constructor
    const randomRecipeFromConstructor = RandomRecipes(
      recipes: [
        Recipe(
          id: 716429,
        ),
    ...
    test('Test random recipe instance equality', () {
      expect(
        randomRecipeFromJson,
        equals(randomRecipeFromConstructor),
      );
    });

    test('Test random recipe from json', () {
      expect(randomRecipeFromJson, isA<RandomRecipes>());
      expect(
        randomRecipeFromJson,
        equals(
          RandomRecipes.fromJson(const <String, dynamic>{
            'recipes': [
              {
                'id': 716429,
                'title':
    ...
    test('Test random recipe to json', () {
      expect(randomRecipeFromJson.toJson(), isA<Map<String, dynamic>>());
      expect(
        randomRecipeFromJson.toJson(),
